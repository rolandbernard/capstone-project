...
\frametitle{Learning Parameters from Data -- Custom YOLO Head}
  \begin{items}
    ...
    \begin{oitem}{\litem}
      ...
      \sitem {\footnotesize Dataset generated from CMU Panoptic by taining random camera view every second.} \\
...
\frametitle{Quantitative Results -- Skeletal Constraints and Learning}
  \begin{items}
    \begin{oitem}{\litem}
      Main Finding: \\
      \sitem {\footnotesize Skeletal constrains give a significant boost in MOTA and MPJPE.} \\
