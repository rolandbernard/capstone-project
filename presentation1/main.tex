...
\begin{frame}
\frametitle{Learning Parameters from Data -- Other Parameters}
  \begin{items}
    % TODO
    \begin{oitem}{\litem}
      Summary: \\
...
\begin{frame}
\frametitle{Quantitative Results -- Skeletal Constraints}
  \begin{items}
    \begin{oitem}{\litem}
      Main Finding: \\
      \sitem {\footnotesize Ipsum laborum incidunt consequatur nobis.} \\
...
\begin{frame}
\frametitle{Quantitative Results -- Learned Parameters}
  \begin{items}
    \begin{oitem}{\litem}
      Main Finding: \\
      \sitem {\footnotesize Ipsum laborum incidunt consequatur nobis.} \\
